...
%% Calculate the body angle between the flies
clearvars('-except',initial_var{:})
...
save_figure(fig,[figDir 'male fly body positions relative to female'],'-png');
...
%% FIGURE: find when flies are on the food
...
head_dist = d <= 3; % mm
% visual check of the close proximity times
...
%% FIGURE: M body positions relative to female during circling
% Pull point locations that will be plotted
skip = 20;
zoom = [-250,250];
...
%% FIGURE: show all points in time with different courtship metrics & CI
clearvars('-except',initial_var{:})
...
kolor = {'grey','purple','grey','teal','grey','gold'}; % chase, wing ext, circling
y1 = 1;
