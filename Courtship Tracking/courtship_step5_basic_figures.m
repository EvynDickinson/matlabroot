...
%% ANALYSIS & FIGURE: Compare wing angles within M and between M and F
clearvars('-except',initial_var{:})
...
%% ANALYSIS & FIGURE: Calculate the body angle between the flies
clearvars('-except',initial_var{:})
...
%% ANALYSIS & FIGURES: Determine male position relative to female
clearvars('-except',initial_var{:})
...
%% ANALYSIS & FIGURE: Distance to food
clearvars('-except',initial_var{:})
...
%% ANALYSIS & FIGURE: male wing extension:
% wing angle > 60 deg
