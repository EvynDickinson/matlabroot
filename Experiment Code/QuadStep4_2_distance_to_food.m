...
%% FIGURE: Plot multiple tuning curves -- select your metric (food vs null) TODO UPDATE THIS
clearvars('-except',initial_vars{:})
...
foreColor = formattingColors(blkbgd); % get foreground color for current background configuration

numOpts = 1:5; % how many curves can be plotted
idx = listdlg('PromptString','How many parameters do you want to plot?','ListString',string(numOpts));
numPlots = numOpts(idx); % get the number of metrics that will be plotted...
