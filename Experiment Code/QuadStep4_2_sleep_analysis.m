...
save_figure(fig,[saveDir 'Sleep\Sleep duration by thermal stress'],fig_type);
...
save_figure(fig,[saveDir 'Sleep\' expGroup ' total sleep'],'-pdf',true,false);
save_figure(fig,[saveDir 'Sleep\' expGroup ' total sleep'],fig_type);
...
% avg distance to a food well across the null distribution:
disp(['Avg mean null position ' num2str(mean(null_distance)) 'mm'])
