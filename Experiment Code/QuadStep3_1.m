...
bin_foods = {'Plant', 'Molasses', 'Glucose', 'Water', 'ACV', 'Sugar','Merlot','glucose','sucrose','Caviar','Movement','German'};
for trial = 1:ntrials
...
hold_protocols = {'Hold25C', 'Hold23C', 'Hold20C'};
...
title({'Location from food sources by temperature';...
      ['N = ' num2str(ntrials)]})
formatFig(fig, true);
save_figure(fig, [figDir ExpGroup ' all temp vs distance' temp_name], '-png');
...
if hold_exp; temp_name = ' fictive temp'; else; temp_name = ''; end
save_figure(fig, [figDir ExpGroup ' temp vs ' inputVar ' bin size ' num2str(binSpace) temp_name], '-png');
clearvars('-except',initial_vars{:})
