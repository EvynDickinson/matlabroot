...
%% Determine the outlines for each arena % TODO
...
if all([~exist([analysisDir 'well_locations.mat'],'file'), ~exist([analysisDir expName ' well_locations.mat'],'file')])
...
switch answer
    case 'Yes'
        export_fig(fig, [analysisDir expName ' arena outlines.png'],'-png' , '-nocrop', '-r80' , '-painters', '-rgb');
        close(fig)
