...
% demo figure (to be moved to 4.2 something else...)
r = 4;
c = 1;
sb(1).idx = 1;
sb(2).idx = 2:4;
...
subplot(r,c,sb(2).idx)
    hold on
    for q = 1:4
        y = smooth(grouped(exp).quadring.(quadOrder{q}).avg,180,'moving');
...
% TODO: 5.29 -- Pool the data for heating and cooling together across the
