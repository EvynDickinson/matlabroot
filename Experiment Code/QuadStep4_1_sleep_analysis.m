...
r = data(i).data(trial).data.r;
xlimit = [x-(r+pixel_buffer),x+(r+pixel_buffer)];
ylimit = [y-(r+pixel_buffer),y+pixel_buffer+r];
...
for i = 1:num.exp 
    ...
    % NULL DISTRIBUTION: 
    null_h = histogram(null_distance,binedges,'FaceColor',Color('white'),'FaceAlpha',0.7);
