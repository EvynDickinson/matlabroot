...
videoNames = 'NonlinearCooling'; %'PlantYeastChoice_N1'; % TODO -- add dynamic option
params.well_1 = 'Plant';
params.well_2 = 'Empty';
params.well_3 = 'Yeast';
params.well_4 = 'Empty';
params.PF_Batch = '8.27'; % batch date for plant food
params.YF_Batch = '8.27'; % batch date for yeast food
...
num.sessionLength = 230;    % total recording length desired (in minutes)
...
if isfile([video_path videoNames 'dataMat.mat']) %prevent overwriting the file
