...
Cross = {'BDP-gal4xUAS-csChrimson', 'BDP-gal4xUAS-gtACR1', 'IAV-gal4xUAS-csChrimson',...        % 1:3
         ...
         '81A06-gal4xcsChrimson', '81A06-gal4xgtACR1', '22A08-gal4xUAS-csChrimson'};  % 19:21 


fly_cross = Cross{7};
% fly_cross = 'Calibration_Test';
filler = '';
max_intensity = str2double(cell2mat(inputdlg('Max light intensity?')));

%% Setup source and side_vid objects for Basler Camera
% PARAMETERS:
parameters.Basler_fps = 30;
