function [excelfile, Excel, xlFile] = load_FlyBowlExperiments
...
Excel.PF_Batch = find(strcmpi('PF Batch', Excel.headers)==1);
Excel.YF_Batch = find(strcmpi('YF Batch', Excel.headers)==1);
