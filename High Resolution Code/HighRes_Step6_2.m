...
for sex = 1:2
    ...
    % plot data
    plot_error_fills(plot_err, x, c_avg, c_err, data.color(sex,:),fig_type);
    plot_error_fills(plot_err, x, w_avg, c_err, data.color(sex,:),fig_type);
    plot(x,c_avg,'color',data.color(sex,:),'linewidth',LW+1,'LineStyle','--')
