...
% TODO (5.11) update all the distances to use the appropriate pixel to mm conversion
% ...but still need to find out what that is for this data structure and account for
% it here.
conversion = getConversion;

% TODO : determine the appropriate conversion ratio for these trials... use the well
% center selected points to calculate once (over in plate comparison)  and then add
% that value to the getConversion function.
...
%% Update the outer rim occupancy that were incorrect before 1.23.25
% TODO (1/28) give a demo image of the ring size for each area on an image still
% ArenaArea = 2827.43;
R = 25; %mm -- this is from looking at the traces of where the flies are able to go in the arena
