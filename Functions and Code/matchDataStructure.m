...
function [rebuildFlag, addFlag, extradataFlag] = matchDataStructure(StructureName, test_T, structFolder)
% [rebuildFlag, addFlag, extradataFlag] = matchDataStructure(structFolder, StructureName, structFolder, T)
%
