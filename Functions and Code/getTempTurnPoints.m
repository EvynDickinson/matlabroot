...
% ===============================
    ...
    case 'Large_temp_sweep_15_35'
        tempPoints.hold = [];
        tempPoints.up =   [22984, 25191;... %[10912, 25191;... % see if this changes the awk cut
                           54064, 82722;...
                           111523, 114759]; %111523, 125430]; % TODO 6.16:  see if this gets rid of the middle cut awkward
    ...
    case 'linear_ramp_XF_25-17'
        tempPoints.hold = [1350, 18079; ...
                                          21012, 35213;...
                                          38204, 52470];
        tempPoints.down = [18080,19565;...
                                            35214, 36746;...
                                            52471, 54024];
        tempPoints.up =   [19566, 21011;...
                                         36747, 38203;...
                                         54025, 55433];
        tempPoints.nRates = 2; 
        tempPoints.rates = [-1, 1]; 
    ...
    case 'linear_ramp_F_25-17_FPS6'
        ...
        tempPoints.hold = [2385 36124;...
                                          47728 76184;...
                                          88021 116668];
        tempPoints.down = [36125 41997;...
                                           76185 82169;...
                                           116669 122399];
        tempPoints.up =   [41998 47727;...
                                       82170 88020;...
                                       122400 128238];
        tempPoints.nRates = 2; 
        tempPoints.rates = [-0.5, 0.5]; 
